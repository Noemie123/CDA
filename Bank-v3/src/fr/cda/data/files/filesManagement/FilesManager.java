...
public class FilesManager {
    ...
    public static void updateCustomersFile() {
        ArrayList<Object> arrCustomersObject = Banque.getListeCustomersObj();
        FilesManager.writeDownAll("clients", arrCustomersObject);
    }

    public static void updateAdvisorsFile() {
        ArrayList<Object> arrAdvisorsObject = Banque.getListeAdvisorsObj();
        FilesManager.writeDownAll("conseillers", arrAdvisorsObject);
    }
